...
import io.opengemini.client.api.QueryResult.SeriesResult;
...
public class MessagePackTraverser {
     ...
     *
     * @param is The MessagePack format input stream
            ...
            switch (type) {
                ...
                case ARRAY:
                    ...
                    if (length > 0) {
                        if ("results".equals(lastStringNode)) {
                            ...
                            SeriesResult result = queryResultPath.getLastObject();
                ...
                case MAP:
                    ...
                    if (queryResultPath.compareEndingPath("results")) {
                        List<SeriesResult> results = queryResultPath.getLastObject();
