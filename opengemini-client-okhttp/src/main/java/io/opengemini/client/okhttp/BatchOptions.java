...
public class BatchOptions {
    ...
    private OpenGeminiClient.ConsistencyLevel consistency;
     ...
     * help to overcome temporary network problems or OpenGeminiClient load spikes.
     ...
     * that the {@link OpenGeminiClient#write(Point)} will be blocked till the space in the queue is created.
    ...
    public OpenGeminiClient.ConsistencyLevel getConsistency() {
